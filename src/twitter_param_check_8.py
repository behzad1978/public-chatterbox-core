...
"""
In this version, we aim to decrease the effect of prob smoothing factors.
So we exclude the probs which are 1 that are caused by only one tok: exclude_toks_with_freq_one_flag
"""
...
saving_dir = home_dir + '/chatterbox-core/twitter_param_results/Results7'
...
sentiment_thresholds_pos_neg = [(0.01, -0.01), (0.25, -0.25), (0.50, -0.50), (0.40, -0.01)]
stop_word_flags = [True]#, False]
pickup_nums_1_and_2 = [(500, 250), (500, 100), (500, 50), (250, 100), (250, 50)]
prob_plus_vals = [2, 3, 5]
prob_close_vals = [0.5, 0.25, 0.125, 0.0625]
str_comp_types = ['quick_ratio']#, 'ratio', 'Levenshtein', 'stringComp']
str_comp_vals = [0.90, 0.75, 0.5]
...
header = [
    ...
    'prob_plus_val', 'pickup_no_1', 'pickup_no_2', 'prob_close_val', 'str_length_flag',
...
#                        weighted_toks_neg = [w for w in weight_freq_neg if w[1] >= average_weight_neg]
                    ...
                    for prob_close_val in prob_close_vals:

                        encompassing_toks_pos = topic_funcs.find_encompassing_toks2(weighted_toks_pos, prob_close_val)
                        encompassing_toks_neg = topic_funcs.find_encompassing_toks2(weighted_toks_neg, prob_close_val)
                            ...
                            for str_comp_type in str_comp_types:
                                for str_comp_val in str_comp_vals:
                                    ...
                                    final_toks_pos = topic_funcs.find_similar_toks(encompassing_toks_pos,
                                        pickup_no_2, str_comp_type, str_comp_val, prob_close_val, str_length_flag)
                                    ...
                                    final_toks_neg = topic_funcs.find_similar_toks(encompassing_toks_neg,
                                        pickup_no_2, str_comp_type, str_comp_type, prob_close_val, str_length_flag)
...
#comparisons.reverse()
#read_write.write_csv_file(saving_dir + '/comparisons', tab_delimiter_flag, unicode_flag, comparisons)
