...
save_dir = '/Chatterbox_UCL_Advance/worry_brit_gas_exp/hashtag_combined/'
current_dir = None
                        ...
                        for keywords_neg in itertools.combinations(keywords_source_neg, j):
                            ...
                            for keyword_combined_pos in itertools.combinations(keywords_combined_source_pos, k):
                                ...
                                for keyword in keyword_combined_pos:
                                    tweets_with_keyword = find_tweets_with_combined_keywords(hash_tweets, keyword)
                                    tweets_with_combined_keywords_pos[keyword] = tweets_with_keyword
                                ...
                                # we cannot put all of them in a single list and create feature vectors.
