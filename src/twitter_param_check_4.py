...
pickup_nums_1 = [int(i * len(tweets))for i in [0.75, 0.50, 0.30, 0.10, 0.05, 0.025]]
pickup_nums_2 = [int(i / 10) for i in pickup_nums_1 if i > 10]
prob_plus_vals = [2, 5, 10]
weight_similarity_vals = [0.25, 0.5, 0.75, 0.9]
quick_ratio_vals = [0.25, 0.5, 0.75, 0.9]
ratio_vals = [0.25, 0.5, 0.75, 0.9]
Levenshtein_vals = [0.25, 0.5, 0.75, 0.9]
stringComp_vals = [0.25, 0.5, 0.75, 0.9]
...
def __get_result(average_weight_pos, stdev_weight_pos, average_weight_neg, stdev_weight_neg,
    ...
    final_toks_pos = topic_funcs.find_similar_toks2(encompassing_toks_pos, string_sim_func, string_sim_val,
        weight_similarity_val)
    ...
    final_toks_neg = topic_funcs.find_similar_toks2(encompassing_toks_neg, string_sim_func, string_sim_val,
        weight_similarity_val)
                ...
                for weight_similarity_val in weight_similarity_vals:
                    ...
                    if quick_ratio_flag:
                        for quick_ratio_val in quick_ratio_vals:
                            params = [sent_pos, sent_neg, 'no pickup_no_1', 'no pickup_no_2', stop_word_flag,
...
my_util.write_csv_file('./Results2/results(no pickupNo)', tab_delimiter_flag, unicode_flag, results)
my_util.pickle_to_file('./Results2/results_pickled(no pickupNo)', results)
...
my_util.write_csv_file('./Results2/comparisons(no pickupNo)', tab_delimiter_flag, unicode_flag, comparisons)
my_util.write_csv_file('./Results2/most_dissimilar_pos(no pickupNo)', tab_delimiter_flag, unicode_flag,
    most_dissimilars_pos)
my_util.write_csv_file('./Results2/most_dissimilar_neg(no pickupNo)', tab_delimiter_flag, unicode_flag,
    most_dissimilars_neg)
...
my_util.write_csv_file('./Results2/final_toks_pos(no pickupNo)', tab_delimiter_flag, unicode_flag, all_toks_pos)
my_util.write_csv_file('./Results2/final_toks_neg(no pickupNo)', tab_delimiter_flag, unicode_flag, all_toks_neg)