...
sentiment_thresholds_pos = [0.75]
sentiment_thresholds_neg = [-0.75]
stop_word_flags = [True]#, False]
pickup_nums_1_and_2 = [(1000, 500), (1000, 250), (1000, 100), (1000, 50), (500, 250), (500, 100), (500, 50), (250, 100), (250, 50)]
prob_plus_vals_pos = [0, 2, 5]
prob_plus_vals_neg = [0, 2, 5]
prob_close_vals = [0.75, 0.5, 0.25]
str_comp_types = ['quick_ratio']#, 'ratio', 'Levenshtein', 'stringComp']
str_comp_vals = [0.75, 0.5, 0.25]
...
header = [
    ...
    'prob_plus_val_pos', 'prob_plus_val_neg', 'pickup_no_1', 'pickup_no_2', 'prob_close_val', 'str_length_flag',
...
for sent_thresh_pos in sentiment_thresholds_pos:
    for sent_thresh_neg in sentiment_thresholds_neg:
        tweets_pos = []
        tweets_neg = []
